...
export default function RandofyContent() {
  ...
  return (
    ...
    <div className="overflow-hidden h-full">
      <div
        className={`flex ${spotifyClient.isLoading ? "w-screen" : "w-full"} pt-4 pb-4 md:pt-0 md:pb-6 flex-col justify-start sm:justify-center items-center relative overflow-hidden z-0`}
      >
